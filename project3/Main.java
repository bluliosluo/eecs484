...
public class Main {
    ...
    static String oracleUserName = "qwluo"; // replace with your uniqname
    static String password = "lqw200208020802"; // replace with your Oracle password (default: eecsclass)
